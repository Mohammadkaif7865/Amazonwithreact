      ...
      <header className="navbar-my">
        <div className="nav-belt-my">
          <button
            ...
            data-bs-target="#demo"
          >
            <i className="bi bi-list" style="font-size:32px; margin: 5px;"></i>
          </button>
          <div
          ...
          >
            <div
              ...
              style="  background-color: #232f3e;display: flex; justify-content: right;"
            >
              <div
                className="off-cav-head"
                style="padding:10px; margin:10px;font-size:30px;"
              >
                <a href="#">
                  <span>
            ...
            <div
              className="hl-hl"
              style="color: white; padding:10px;  background-color: #232f3e;"
            >
              <h2>
                <b>Browse</b>
              </h2>
            ...
            <div className="offcanvas-body">
              ...
              <a href="#">
                <h3>
                  ...
                  <img src="https://img.icons8.com/color/25/000000/india.png" />
                </h3>
              </a>
              <a href="#">
                <h3>
            ...
            <form action="search-input" className="form-search-my">
              <div className="select-cat-my nav-search-my">
                <select name="category" id="select-category">
                  ...
                  <option value="specialty-aps-sns">
                    Subscribe &amp; Save
                  </option>
              ...
              <button type="submit" className="search-submit-my">
                <i className="bi bi-search" style="font-size:23px;"></i>
              </button>
            </form>
          </div>
          <div className="region-my" id="region-country">
            <a href="#">
              <div className="national-flag-my">
                ...
                <i
                  ...
                  style="color: #959fa9;font-size:8px;"
                ></i>
              </div>
            </a>
            <div className="dropdown-region-lan-menu-my">
              <i
                ...
                style="font-size:50px; color:white;position:absolute; top: -35px;left:13px;"
              ></i>
              ...
              <div
                ...
                style="border-bottom: 2px solid rgb(189, 169, 169);"
              >
              ...
              <div className="change-region-my">
                ...
                <p style="margin-top: 20px;margin-left: 10px;">
                  <a
                    href="#"
                    style="text-decoration:none; color:blue !important;"
                  >
          ...
          <a href="#">
            <div className="order-returns-my">
              <p style="color:#959fa9;margin-top: 20px;">Returns</p>
          ...
          <a href="#">
            <div className="cart-my">
              ...
              <div className="number-of-items-my" style="font-size:15px;">
                <b>10</b>
              </div>
            </div>
          </a>
        ...
        <div className="nav-main-my">
          <a href="#">
            <div className="main-belt-item" style="margin-left: 5px;">
              <i
